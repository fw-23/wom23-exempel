...
// wss = SSL-krypterad
WS_URL = `wss://wom-ws-pastebin.azurewebsites.net?token=${WS_TOKEN}` 
...
socket.onopen = function (event) {
    ...
    document.querySelector('#status').innerText = 'Connected to WebSocket server';
};
...
socket.onclose = function (event) {
    ...
    document.querySelector('#status').innerText = 'Connection closed';
};
